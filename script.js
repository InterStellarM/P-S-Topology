...
const gridData = {
    ...
    rows: [
        ...
        { label: "Separable",                   cells: ["green", "gray", "gray", "green", "green", "red",   "gray",    "gray", "gray",   "gray",  "red"] },
        { label: "Lindelöf",                    cells: ["green", "green", "red",   "green", "green", "red",   "gray",    "gray", "gray",   "gray",  "green"] },
